    ...
    public class RobotsController : Controller
    {
        ...
        public void RsdXml()
        {
            ...
            using (var xml = XmlWriter.Create(Response.Body, new XmlWriterSettings { Indent = true }))
            {
                ...
                xml.WriteElementString("enginename", "myblog");
                xml.WriteElementString("enginelink", "http://github.com/madskristensen/myblog/");
        ...
        private async Task<ISyndicationFeedWriter> GetWriter(string type, XmlWriter xmlWriter, DateTime updated)
        {
            ...
            await atom.WriteGenerator("myblog", "https://github.com/madskristensen/myblog", "1.0");
